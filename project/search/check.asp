...
rs.open "select * from diamond where(shape='"&shape&"' AND color_desc='"&color_d&"' AND color='"&c&"' AND clarity='"&cl&"'  AND fluorescence='"&f&"' AND lab='"&l&"' AND shade='"&s&"' AND polish='"&p&"' AND cut='"&cu&"' AND symmetry='"&sm&"' AND location='"&lo&"')",conn
%>
<div class="wrapper">

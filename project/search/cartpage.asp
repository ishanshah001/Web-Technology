...
set con = Server.CreateObject("ADODB.Connection")
	...
	sql="SELECT * FROM [cart] INNER JOIN [diamond] ON cart.ID = diamond.ID where cart.username='"&username&"' ORDER BY cart.ID"
	res.open sql,con
%>

<div class="wrapper">
	<h2>&nbsp&nbsp&nbspWelcome to the cart</h2>
...
do while not res.EOF
	Response.write("<tr><td>"&res("cart.ID")&"</td>")
...
%></table>
	...
	<h2>&nbsp&nbsp&nbspDelete an item?</h2>
<div class="content" style="display:inline-block;">
...
<h2>&nbsp&nbsp&nbspConfirm order?</h2>
<div class="content" style="display:inline-block;">
